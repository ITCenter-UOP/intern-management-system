...
router.post('/add-today-works/:id', auth, checkPermission(['project:todaysdone']), ProjectController.todays_work)

router.get('/my-works-done', auth, checkPermission(['project:mywokrs']), ProjectController.get_my_works)
